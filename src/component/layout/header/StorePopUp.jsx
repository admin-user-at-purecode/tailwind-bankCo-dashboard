...
function StorePopUp({ active }) {
    return (
        <div className="store-wrapper text-left">
            <div
                id="store-box"
                style={{
                ...
                className={`absolute  transition-all origin-top right-[0px] top-[81px] hidden w-[330px] overflow-hidden rounded-lg bg-white dark:bg-darkblack-600  ${
