...
import PaymentAndBilling from "../../../component/settings/PaymentAndBilling";
import AddMoney from "../../../component/settings/AddMoney";
import Slider from "../../../component/slider";

function Payment() {
  return (
    <div id="tab4" className="tab-pane active">
      {/* Cards  */}
      <PaymentAndBilling />
      {/* Slider  */}
